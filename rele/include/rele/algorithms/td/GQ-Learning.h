...
#ifndef INCLUDE_RELE_ALGORITHMS_TD_GQ_LEARNING_H_
#define INCLUDE_RELE_ALGORITHMS_TD_GQ_LEARNING_H_
 ...
 * ...
 */
class GQ_Learning: public Q_Learning
{
public:
...
public:
    GQ_Learning(ActionValuePolicy<FiniteState>& policy, LearningRate& alpha, unsigned int nsamples);
    ...
    virtual void computeWeights(size_t xn);
